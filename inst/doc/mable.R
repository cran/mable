...
## ----fig.align='center', fig.cap="Breast Cosmesis Data\\label{fig:Breast-Cosmesis-Data-plot}", fig.width=7, fig.height=7----
op<-par(mfrow=c(2,2),lwd=2)
...
## ----fig.align='center', fig.cap="Density Estimate based on the Old Faithful Data\\label{fig:Old-Faithful-Data-plot}", fig.width=6, fig.height=6----
...
## ----fig.align='center', fig.cap="Ovarian Cancer Data\\label{fig:ovarian-Data-plot}", fig.width=7, fig.height=7----
op<-par(mfrow=c(2,2))
...
## ----fig.align='center', fig.cap="AFT Model Fit for Breast Cosmesis Data\\label{fig:Breast-Cosmesis-Data-aft-plot}", fig.width=7, fig.height=4----
...
## ----results = "hide"---------------------------------------------------------
aft.res1<-mable.reg(cbind(left, right)~x, data=bcos2, 'aft', M=c(1, 30), tau=100, x0=1)
