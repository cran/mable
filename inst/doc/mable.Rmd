...
vignette: >
  %\VignetteIndexEntry{Maximum Approximate Bernstein/Beta Likelihood Estimation in R package 'mable' v2.0} 
  %\VignetteEngine{knitr::rmarkdown} 
  %\VignettEncoding{UTF-8}
---
...
```{r  fig.align='center', fig.cap="Breast Cosmesis Data\\label{fig:Breast-Cosmesis-Data-plot}", fig.width=7, fig.height=7}
op<-par(mfrow=c(2,2),lwd=2)
...
```
```{r fig.align='center', fig.cap="Density Estimate based on the Old Faithful Data\\label{fig:Old-Faithful-Data-plot}", fig.width=6, fig.height=6}
...
summary(ova)
```
```{r fig.align='center', fig.cap="Ovarian Cancer Data\\label{fig:ovarian-Data-plot}", fig.width=7, fig.height=7}
op<-par(mfrow=c(2,2))
...
summary(aft.res)
```
```{r fig.align='center', fig.cap="AFT Model Fit for Breast Cosmesis Data\\label{fig:Breast-Cosmesis-Data-aft-plot}", fig.width=7, fig.height=4}
