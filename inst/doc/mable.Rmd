...
```{r  fig.align='center', fig.cap="Breast Cosmesis Data\\label{fig:Breast-Cosmesis-Data-plot}", fig.width=7, fig.height=7, warning = FALSE}
op <- par(mfrow = c(2,2),lwd = 2)
...
summary(ova)
```
```{r fig.align='center', fig.cap="Ovarian Cancer Data\\label{fig:ovarian-Data-plot}", fig.width=7, fig.height=7, warning = FALSE}
op <- par(mfrow = c(2,2))
